...
?>
    <!-- filter -->
    <style type="text/css" href="https://cdnjs.cloudflare.com/ajax/libs/TableExport/3.3.13/css/tableexport.min.css"></style>
...
<?php
    ...
    // echo '$(".dataListPrinted").tableExport();';
    /* Modifide by Drajat Hasan */
    echo 'TableExport(document.getElementsByTagName("table"), {
              headers: true,                      // (Boolean), display table headers (th or td elements) in the <thead>, (default: true)
              footers: true,                      // (Boolean), display table footers (th or td elements) in the <tfoot>, (default: false)
              formats: ["xls", "csv"],    // (String[]), filetype(s) for the export, (default: [\'xlsx\', \'csv\', \'txt\'])
              filename: "item_useage_report",                     // (id, String), filename for the downloaded file, (default: \'id\')
